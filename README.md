...
- Basic tools
  - LP solvers
    - [pycddlib](https://pypi.org/project/pycddlib/)
      - [solving LPs](https://pycddlib.readthedocs.io/en/latest/examples.html#solving-linear-programs)
      - [matrix games](https://github.com/rahulsavani/zerosum_matrix_game_solver)
- Other frameworks
...
- Similar libraries
  ...
  - [Game Theory Explorer](https://gte.csc.liv.ac.uk/index/) - Create and analyze games as models of strategic interaction.
...
- Interactive applications
  - [bimatrix solver](https://cgi.csc.liv.ac.uk/~rahul/bimatrix_solver/)
    - [backend](https://github.com/rahulsavani/bimatrix_solver)  
- Game generators and examples
  - [bimatrix games](https://github.com/bimatrix-games)
  - [polymatrix games](https://github.com/polymatrix-games)
- Courses
